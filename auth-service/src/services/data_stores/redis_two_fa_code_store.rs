...
impl TwoFACodeStore for RedisTwoFACodeStore {
    #[tracing::instrument(name = "redis two fa code store add code", skip_all)]
    async fn add_code(
        &mut self,
        email: Email,
    ...
    #[tracing::instrument(name = "redis two fa code store remove code", skip_all)]
    ...
    #[tracing::instrument(name = "redis two fa code store get code", skip_all)]
    async fn get_code(
        &self,
        email: &Email,
